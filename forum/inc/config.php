...
$config['database']['database'] = 'nsamrorg_forum';
$config['database']['table_prefix'] = 'mybb_';

$config['database']['hostname'] = '10.169.0.78';
$config['database']['username'] = 'nsamrorg_forum';
$config['database']['password'] = 'D@tabaseForum2016';
