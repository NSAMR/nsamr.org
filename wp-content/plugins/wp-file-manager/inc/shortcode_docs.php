...
<h1><?php _e('File Manager PRO - Shortcode','ffm'); ?>  <a href="http://www.webdesi9.com/product/file-manager/" class="button button-primary" target="_blank" title="Click to Buy PRO"><?php  _e('Buy PRO', 'ffm'); ?></a></h1>
